                ...
                <form action="{{ route('admin.event.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body pt-0">
                        <div class="row mt-1 g-5">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control @error('venue') is-invalid @enderror" type="text"
                                        id="venue" name="venue" value="{{ old('venue') }}" autofocus
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control @error('venue_maps_url') is-invalid @enderror" type="url"
                                        id="venue_maps_url" name="venue_maps_url" value="{{ old('venue_maps_url') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control @error('schedule') is-invalid @enderror" type="date"
                                        id="schedule" name="schedule" value="{{ old('schedule') }}" autofocus
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control @error('total_quota') is-invalid @enderror" type="number"
                                        id="total_quota" name="total_quota" value="{{ old('total_quota') }}" autofocus
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control @error('start_time') is-invalid @enderror" type="time"
                                        id="start_time" name="start_time" value="{{ old('start_time') }}" autofocus
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control @error('end_time') is-invalid @enderror" type="time"
                                        id="end_time" name="end_time" value="{{ old('end_time') }}" autofocus
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control @error('cp_email') is-invalid @enderror" type="email"
                                        id="cp_email" name="cp_email" value="{{ old('cp_email') }}" autofocus
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control @error('cp_phone') is-invalid @enderror" type="text"
                                        id="cp_phone" name="cp_phone" value="{{ old('cp_phone') }}" autofocus
