                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                    rows="3" placeholder="Enter form description (optional)">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="cover_path" id="cover_path"
                                    ...
                                    value="{{ old('cover_path') }}" placeholder="Enter cover path (optional)">
                                @error('cover_path')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="cover_file" id="cover_file"
                                    ...
                                    value="{{ old('cover_file') }}" placeholder="Enter cover file (optional)">
                                @error('cover_file')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
