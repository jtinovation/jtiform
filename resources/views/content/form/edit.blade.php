        ...
        <form action="{{ route('form.update', $form->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body pt-0">
                <div class="row mt-1 g-5">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control @error('start_at') is-invalid @enderror" type="datetime-local"
                                ...
                                value="{{ old('start_at', \Carbon\Carbon::parse($form->start_at)->format('Y-m-d\TH:i')) }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control @error('end_at') is-invalid @enderror" type="datetime-local"
                                ...
                                value="{{ old('end_at', \Carbon\Carbon::parse($form->end_at)->format('Y-m-d\TH:i')) }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-floating form-floating-outline">
                            <select name="type" id="type" class="form-select @error('type') is-invalid @enderror"
                                required>
                                <option value="" disabled {{ old('type', $form->type) ? '' : 'selected' }}>-- Pilih
                                    Tipe --</option>
                                <option value="{{ FormTypeEnum::GENERAL }}"
                                    {{ old('type', $form->type) == FormTypeEnum::GENERAL->value ? 'selected' : '' }}>
                                    Umum</option>
                                <option value="{{ FormTypeEnum::LECTURE_EVALUATION }}"
                                    {{ old('type', $form->type) == FormTypeEnum::LECTURE_EVALUATION->value ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12">
                        @php
                            $respondenType = old('responden_type', $form->respondents['type'] ?? '');
                        @endphp
                        <div class="form-floating form-floating-outline">
                            <select name="responden_type" id="responden_type"
                                ...
                                <option value="{{ FormRespondentTypeEnum::MAJOR }}"
                                    {{ old('responden_type', $respondenType) == FormRespondentTypeEnum::MAJOR->value ? 'selected' : '' }}>
                                    Jurusan</option>
                                <option value="{{ FormRespondentTypeEnum::STUDY_PROGRAM }}"
                                    {{ old('responden_type', $respondenType) == FormRespondentTypeEnum::STUDY_PROGRAM->value ? 'selected' : '' }}>
                                    Program Studi</option>
                                <option value="{{ FormRespondentTypeEnum::STUDENT }}"
                                    {{ old('responden_type', $respondenType) == FormRespondentTypeEnum::STUDENT->value ? 'selected' : '' }}>
                                    Spesifik Mahasiswa</option>
                                <option value="{{ FormRespondentTypeEnum::LECTURER }}"
                                    {{ old('responden_type', $respondenType) == FormRespondentTypeEnum::LECTURER->value ? 'selected' : '' }}>
                                    Spesifik Dosen</option>
                                <option value="{{ FormRespondentTypeEnum::EDUCATIONAL_STAFF }}"
                                    {{ old('responden_type', $respondenType) == FormRespondentTypeEnum::EDUCATIONAL_STAFF->value ? 'selected' : '' }}>
                                    Spesifik Tendik</option>
                            </select>
