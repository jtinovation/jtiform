                    ...
                    <form class="d-flex">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control search-input" name="search-input"
                                data-target="#form-master-table" placeholder="Search..." />
                        </div>
                    </form>
                </div>
            </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('form.edit', $form->id) }}"><i
                                                        class="ri-pencil-line me-1"></i> Edit Form</a>

                                                {{-- Tombol Delete pakai data-id untuk JS --}}
                                                <form action="{{ route('form.hapus', $form->id) }}" method="POST"
                                                ...
                                                <a class="dropdown-item"
                                                    href=" {{ route('form.questions', ['id' => $form->id]) }} "><i
                                                        class="ri-questionnaire-line me-1"></i> List Pertanyaan</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
