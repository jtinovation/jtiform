...
@section('page-script')
      ...
      <div class="card-body pt-3">
        ...
        <div class="row g-4">
          <div class="col-md-7">
            <div class="form-floating form-floating-outline">
              <input type="text" class="form-control field-question" name="questions[${idx}][question]" placeholder="Tulis pertanyaan" value="${escapeHtml(q)}" required>
          ...
          <div class="col-md-2 d-flex align-items-center">
            <div class="form-check form-switch">
              <input class="form-check-input field-required" type="checkbox" name="questions[${idx}][is_required]" value="1" ${requiredChecked}>
        ...
        <div class="mt-4 options-box" style="display:none">
          ...
          <div class="options-wrapper list-group"></div>
            ...
            // Tambahkan satu baris opsi (answer + point + hidden sequence) + drag handle
    ...
    `;
            ...
            // Aktifkan Sortable per "options-wrapper" (tiap pertanyaan)
            function initOptionsSortable($card) {
                const wrapEl = $card.find('.options-wrapper').get(0);
                if (!wrapEl || wrapEl.__sortable_inited) return; // hindari double init
            ...
            // Tampilkan/hidden box opsi sesuai type
            ...
            // Update nomor urut & name atribute options => [sequence], [label], [point]
