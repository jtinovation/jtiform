  ...
  <div class="card-header">
    <div class="d-flex justify-content-between">
      <div class="card-header-left d-flex flex-column">
        ...
        <a href="{{ route('question.create', $form->id) }}" class="btn btn-primary">
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('question.edit', [$form->id, $question->id]) }}">
                      <i class="ri-pencil-line me-1"></i> Edit Pertanyaan
                    </a>
                    <form action="{{ route('question.delete', [$form->id, $question->id]) }}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button type="submit" class="dropdown-item text-danger">
                        <i class="ri-delete-bin-6-line me-1"></i> Hapus Pertanyaan
                      </button>
                    </form>
                  </div>
                </div>
